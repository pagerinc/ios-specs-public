...
Pod::Spec.new do |s|
    ...
    s.source       = { :http => 'https://pagerinc.jfrog.io/pagerinc/npm/%40pager/ios-pager-kit/-/%40pager/ios-pager-kit-4.5.0.tgz' }
    s.requires_arc      = true
    s.libraries = 'z' , 'c++'
    ...
    s.dependency 'ZoomVideoSDK', '2.5.7'
    s.dependency 'Pendo', '~> 3.13.0'
